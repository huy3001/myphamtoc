...
define( 'NOTIFIER_THEME_NAME', 'Beauty' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'beauty' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', themerex_get_protocol() . '://themerex.net/!updates/updates_beauty.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
